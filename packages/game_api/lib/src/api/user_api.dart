...
class UserApi {
  ...
  Future<Response<ApiUsersGetCollection200Response>> apiUsersGetCollection({ 
    ...
    ApiUsersGetCollection200Response _responseData;

    try {
      const _responseType = FullType(ApiUsersGetCollection200Response);
    ...
    return Response<ApiUsersGetCollection200Response>(
      data: _responseData,
  ...
  Future<Response<UserJsonldUserRead>> apiUsersIdGet({ 
    ...
    UserJsonldUserRead _responseData;

    try {
      const _responseType = FullType(UserJsonldUserRead);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<UserJsonldUserRead>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [id] - User identifier
  /// * [userJsonldUserUpdate] - The updated User resource
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
