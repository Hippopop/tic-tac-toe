...
import 'package:openapi/src/api/game_api.dart';
import 'package:openapi/src/api/token_api.dart';
import 'package:openapi/src/api/turn_api.dart';
...
class Openapi {
  ...
  /// Get TurnApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  TurnApi getTurnApi() {
    return TurnApi(dio, serializers);
  }
